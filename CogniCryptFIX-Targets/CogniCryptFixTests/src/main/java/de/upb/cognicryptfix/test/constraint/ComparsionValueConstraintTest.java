...
public class ComparsionValueConstraintTest {
	...
	public void test01() throws Exception{
		...
		byte[] plainText = "HelloWorld".getBytes();
	...
	/**
	 * "HelloWorld" -> "secp128r1"
	 * @throws NoSuchAlgorithmException
	 */
	@SuppressWarnings("unused")
	public void test07() {
		ECGenParameterSpec ecGenSpec = new ECGenParameterSpec("HelloWorld");
	}
	 ...
	 */
	@SuppressWarnings("unused")
	public void test08() throws NoSuchAlgorithmException, InvalidAlgorithmParameterException {
		
		ECGenParameterSpec paramterSpec = new ECGenParameterSpec("wrong!");
		KeyPairGenerator pairGenerator = KeyPairGenerator.getInstance("EC");
		pairGenerator.initialize(paramterSpec);
		KeyPair kp = pairGenerator.generateKeyPair();
	}
}
